...
import { AuditAction, AuditResourceType } from '@/features/audit/shared/interface';
...
describe('GET /api/admin/audit/resource/:type/:id - Unit Tests', () => {
  ...
  describe('Resource History Retrieval', () => {
    it('should get audit trail for specific resource', async () => {
      ...
      const result = await mockAuditService.getAuditTrail(AuditResourceType.USER, 123);

      expect(mockAuditService.getAuditTrail).toHaveBeenCalledWith(AuditResourceType.USER, 123);
    ...
    it('should respect limit parameter', async () => {
      ...
      await mockAuditService.getAuditTrail(AuditResourceType.USER, 123, 10);

      expect(mockAuditService.getAuditTrail).toHaveBeenCalledWith(AuditResourceType.USER, 123, 10);
    });
  });
  ...
  describe('Change Tracking', () => {
    it('should show before and after values', async () => {
      ...
      const result = await mockAuditService.getAuditTrail(AuditResourceType.ROLE, 5);
    ...
    it('should handle creation events without old values', async () => {
      ...
      const result = await mockAuditService.getAuditTrail(AuditResourceType.USER, 456);
    ...
    it('should handle deletion events without new values', async () => {
      ...
      const result = await mockAuditService.getAuditTrail(AuditResourceType.PERMISSION, 789);
  ...
  describe('Edge Cases', () => {
    it('should return empty array for non-existent resource', async () => {
      ...
      const result = await mockAuditService.getAuditTrail(AuditResourceType.USER, 99999);
    ...
    it('should handle errors gracefully', async () => {
      ...
      await expect(mockAuditService.getAuditTrail(AuditResourceType.USER, 1)).rejects.toThrow(
        'Database error'
      );
    });
  });
