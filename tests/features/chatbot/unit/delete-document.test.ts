...
import { getDocumentById, deleteDocument } from '@/features/chatbot/shared/queries';
import { deleteDocumentVectors } from '@/features/chatbot/services/vector.service';

jest.mock('@/features/chatbot/shared/queries');
jest.mock('@/features/chatbot/services/vector.service');
