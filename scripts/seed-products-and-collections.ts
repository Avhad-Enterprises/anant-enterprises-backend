...
async function seedData() {
  ...
  if (oldCollections.length > 0) {
    ...
    await db
      ...
      .where(inArray(collectionProducts.collection_id, oldCollectionIds));
  ...
  console.log('\n🔑 Product Statuses:');
  console.log(
    '   • Active: AP-RO-500, AP-RO-300, PF-UV-PRO, PF-UV-LITE, COMM-RO-1000, COMM-RO-2000'
  );
