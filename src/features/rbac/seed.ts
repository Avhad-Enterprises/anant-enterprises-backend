...
export const INITIAL_PERMISSIONS = [
    ...
    { name: 'users:read:own', resource: 'users', action: 'read:own', description: 'View own profile' },
    { name: 'users:create', resource: 'users', action: 'create', description: 'Create new users' },
    { name: 'users:update', resource: 'users', action: 'update', description: 'Update any user' },
    { name: 'users:update:own', resource: 'users', action: 'update:own', description: 'Update own profile' },
    { name: 'users:delete', resource: 'users', action: 'delete', description: 'Delete users' },

    // Role Management
    { name: 'roles:read', resource: 'roles', action: 'read', description: 'View all roles' },
    { name: 'roles:manage', resource: 'roles', action: 'manage', description: 'Create, update, delete roles' },

    // Permission Management
    { name: 'permissions:read', resource: 'permissions', action: 'read', description: 'View all permissions' },
    ...
    { name: 'uploads:read:own', resource: 'uploads', action: 'read:own', description: 'View own uploads' },
    { name: 'uploads:create', resource: 'uploads', action: 'create', description: 'Upload files' },
    { name: 'uploads:delete', resource: 'uploads', action: 'delete', description: 'Delete any upload' },
    { name: 'uploads:delete:own', resource: 'uploads', action: 'delete:own', description: 'Delete own uploads' },

    // Admin Functions
    { name: 'admin:invitations', resource: 'admin', action: 'invitations', description: 'Send user invitations' },
    ...
    { name: 'chatbot:documents', resource: 'chatbot', action: 'documents', description: 'Manage chatbot documents' },
...
async function seedRoles() {
    ...
    const insertedRoles = await db.insert(roles).values([...SYSTEM_ROLES]).returning();
...
async function seedPermissions() {
    ...
    const insertedPermissions = await db.insert(permissions).values([...INITIAL_PERMISSIONS]).returning();
