...
export const cartSourceEnum = pgEnum('cart_source', ['web', 'app']);
...
export const carts = pgTable(
  'carts',
  {
    ...
    discount_total: decimal('discount_total', { precision: 12, scale: 2 })
      .default('0.00')
      .notNull(),
    giftcard_total: decimal('giftcard_total', { precision: 12, scale: 2 })
      .default('0.00')
      .notNull(),
  ...
  table => ({
    ...
    statusActivityIdx: index('carts_status_activity_idx').on(
      table.cart_status,
