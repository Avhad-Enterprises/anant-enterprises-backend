...
export const productionOrders = pgTable(
    ...
    table => ({
        ...
        productStatusIdx: index('production_orders_product_status_idx').on(table.product_id, table.status),
        statusPriorityIdx: index('production_orders_status_priority_idx').on(table.status, table.priority),
        scheduledCompletionIdx: index('production_orders_scheduled_completion_idx')
            .on(table.scheduled_completion_date),
    })
);
