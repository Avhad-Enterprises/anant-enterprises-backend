/**
 * GET /api/admin/payments/customer/:userId
 *
 * Retrieves all payment transactions for a specific customer (Admin).
...
const handler = async (req: RequestWithUser, res: Response) => {
  ...
  // Base condition - transactions for the specific user's orders
...
const router = Router();
router.get('/admin/payments/customer/:userId', requireAuth, requirePermission('orders:read'), handler);
