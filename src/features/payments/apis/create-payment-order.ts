...
const handler = async (req: RequestWithUser, res: Response) => {
    ...
    const result = await PaymentLockService.withLock(body.order_id, async () => {
        ...
        // NOTE: Cart validation removed - order amount is already validated and frozen during order creation.
        // For Razorpay payments, cart intentionally remains 'active' until payment verification,
        // making cart state validation unnecessary and prone to false positives.
