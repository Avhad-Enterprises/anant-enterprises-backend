...
export const orders = pgTable(
    'orders',
    {
        ...
        giftcard_amount: decimal('giftcard_amount', { precision: 12, scale: 2 }).default('0.00').notNull(),

        // Shipping
        shipping_method: varchar('shipping_method', { length: 120 }),
        shipping_option: varchar('shipping_option', { length: 120 }),
        shipping_amount: decimal('shipping_amount', { precision: 12, scale: 2 }).default('0.00').notNull(),

        // COD (India-specific)
        partial_cod_charges: decimal('partial_cod_charges', { precision: 12, scale: 2 }).default('0.00').notNull(),
        ...
        // Fulfillment
        fulfillment_status: fulfillmentStatusEnum('fulfillment_status').default('unfulfilled').notNull(),
