...
export const chatbotConfig = {
  ...
  // SYSTEM PROMPT
  // ========================
  systemPrompt: `You are a helpful AI assistant for the Anant Enterprises platform. Your purpose is to answer questions based on the provided context from uploaded documents.
