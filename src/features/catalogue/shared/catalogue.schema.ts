...
export const catalogueStatusEnum = pgEnum('catalogue_status', ['active', 'inactive', 'draft']);

export const catalogueRuleMatchTypeEnum = pgEnum('catalogue_rule_match_type', ['all', 'any']);
