describe('Cache Service', () => {
    ...
    describe('set method', () => {
        ...
        it('should set value with default TTL', async () => {
            ...
            expect(mockRedisClient.setEx).toHaveBeenCalledWith('test-key', 300, JSON.stringify({ data: 'test' }));
        });
        ...
        it('should set value with custom TTL', async () => {
            ...
            expect(result).toBe(true);
            expect(mockRedisClient.setEx).toHaveBeenCalledWith('test-key', 600, JSON.stringify('test-value'));
        });
...
describe('Cache Keys', () => {
    ...
    describe('Rate limit keys', () => {
        it('should generate rate limit cache key', () => {
            expect(cacheKeys.rateLimit('192.168.1.1', '/api/users')).toBe('ratelimit:192.168.1.1:/api/users');
        });
    });
});
