...
export default defineConfig({
  schema: [
    // Core User & Auth (1 table: users)
    './src/features/user/shared/user.schema.ts',
    // Admin (1 table: admin_profiles)
    './src/features/admin/shared/admin-profiles.schema.ts',
    // Customer (3 tables: customer_profiles, customer_statistics, business_customer_profiles)
    ...
    // Address (2 tables: addresses, payment_methods)
    './src/features/address/shared/addresses.schema.ts',
    './src/features/address/shared/payment-methods.schema.ts',
    ...
    // Customer Segments (3 tables)
    './src/features/customer-segment/shared/customer-segments.schema.ts',
  ],
